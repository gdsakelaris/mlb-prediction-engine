...
mid-season get a single aggregated row for the year, attributed to their
most recent team.

Relational keys shared with mlb_rosters.csv:
...
Usage:
    python scrape_batting_stats.py [-o output.csv] [--backfill]
"""
...
def main():
    ...
    ap.add_argument("-o", "--output",
                    default=str(DATA_DIR / "mlb_batting_stats.csv"))
